...
struct CpuThread: Thread<CpuThread> {
    ...
    CpuThread(int id, int32_t min_size, bool origin, GpuOutputs &inputs, CpuOutputs &outputs);
...
int32_t measure_1to1(Cubiomes *cubiomes, int32_t cx, int32_t cz, int32_t radius, int32_t *out_x, int32_t *out_z, bool *hit_edge, bool from_center = false);
